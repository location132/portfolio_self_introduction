...
import 'general_project_desktop_item.dart';

class GeneralProjectsDesktopView extends StatelessWidget {
  const GeneralProjectsDesktopView({super.key});

  @override
  Widget build(BuildContext context) {
    return const Column(
      children: [
        GeneralProjectDesktopItem(
          date: '7월 16일',
          title: 'NaverMap',
