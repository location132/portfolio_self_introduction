...
import 'mobile_background_feature_card.dart';

class MobileBackgroundFeatures extends StatefulWidget {
  final bool isVisible;

  const MobileBackgroundFeatures({super.key, required this.isVisible});

  @override
  State<MobileBackgroundFeatures> createState() =>
      _MobileBackgroundFeaturesState();
}

class _MobileBackgroundFeaturesState extends State<MobileBackgroundFeatures> {
  ...
  Widget build(BuildContext context) {
    final visibleFeatures = _isExpanded ? features : features.take(2).toList();

    return WidgetAnimation(
      isStart: widget.isVisible,
      duration: 1000,
      beginDy: 0.05,
      child: Column(
        children: [
          ...visibleFeatures.map(
            (feature) => Padding(
              ...
              child: MobileBackgroundFeatureCard(
                title: feature['title'] as String,
                subtitle: feature['subtitle'] as String,
                icon: feature['icon'] as IconData,
                features: feature['features'] as List<String>,
              ),
            ),
          ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    _isExpanded ? '접기' : '더보기 (${features.length - 2}개)',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 12.sp,
