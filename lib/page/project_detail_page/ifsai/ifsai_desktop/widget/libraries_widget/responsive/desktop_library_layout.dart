...
class DesktopLibraryLayout extends StatefulWidget {
  final IfsaiState state;
  const DesktopLibraryLayout({super.key, required this.state});

  static Widget build(IfsaiState state) {
    return DesktopLibraryLayout(state: state);
  }

  @override
  State<DesktopLibraryLayout> createState() => _DesktopLibraryLayoutState();
}

class _DesktopLibraryLayoutState extends State<DesktopLibraryLayout>
  ...
  @override
  void didUpdateWidget(DesktopLibraryLayout oldWidget) {
