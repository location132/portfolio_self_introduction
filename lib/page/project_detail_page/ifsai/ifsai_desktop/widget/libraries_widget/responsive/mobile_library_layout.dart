...
class MobileLibraryLayout extends StatefulWidget {
  final IfsaiState state;
  const MobileLibraryLayout({super.key, required this.state});

  static Widget build(IfsaiState state) {
    return MobileLibraryLayout(state: state);
  }

  @override
  State<MobileLibraryLayout> createState() => _MobileLibraryLayoutState();
}

class _MobileLibraryLayoutState extends State<MobileLibraryLayout>
  ...
  @override
  void didUpdateWidget(MobileLibraryLayout oldWidget) {
      ...
      child: Column(
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            height: widget.state.isLibraryDetailVisible ? 80 : 40,
          ),
          SizedBox(
            height: 1000,
            child: Stack(
