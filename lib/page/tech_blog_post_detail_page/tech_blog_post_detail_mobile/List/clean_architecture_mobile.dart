...
import 'package:self_introduction_flutter/page/tech_blog_post_detail_page/tech_blog_post_detail_mobile/List/widget/domain_layer_mobile.dart';
import 'package:self_introduction_flutter/page/tech_blog_post_detail_page/tech_blog_post_detail_mobile/List/widget/expandable_content_mobile.dart';
import 'package:self_introduction_flutter/page/tech_blog_post_detail_page/tech_blog_post_detail_mobile/List/widget/post_header_mobile.dart';
import 'package:self_introduction_flutter/page/tech_blog_post_detail_page/tech_blog_post_detail_mobile/List/widget/presentation_layer_mobile.dart';
import 'package:self_introduction_flutter/page/tech_blog_post_detail_page/tech_blog_post_detail_mobile/List/widget/repository_pattern_mobile.dart';
import 'package:self_introduction_flutter/page/tech_blog_post_detail_page/tech_blog_post_detail_mobile/List/widget/title_text_tech_mobile.dart';
import 'package:self_introduction_flutter/page/tech_blog_post_detail_page/tech_blog_post_detail_state.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class CleanArchitectureMobile extends StatefulWidget {
  final Function(bool) isFocused;
  final ScrollController? scrollController;
  const CleanArchitectureMobile({
    super.key,
  ...
  @override
  State<CleanArchitectureMobile> createState() =>
      _CleanArchitectureMobileState();
}

class _CleanArchitectureMobileState extends State<CleanArchitectureMobile> {
