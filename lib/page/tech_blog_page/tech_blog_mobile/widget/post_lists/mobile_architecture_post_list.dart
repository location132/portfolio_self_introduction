    ...
    return Column(
      ...
      children: [
        MobileTechPostTitle(
          ...
          onTap: () => context.push('/tech-blog/post/mvvm'),
        ),
        ...
        MobileTechPostTitle(
          ...
          onTap: () => context.push('/tech-blog/post/repository-pattern'),
        ),
        SizedBox(height: 30.h),
        MobileTechPostTitle(
          number: 4,
          ...
          onTap: () => context.push('/tech-blog/post/bloc-cubit'),
        ),
        SizedBox(height: 30.h),
        MobileTechPostTitle(
          number: 5,
        ...
        MobileTechPostTitle(
          ...
          onTap: () => context.push('/tech-blog/post/dependency-injection'),
        ),
        SizedBox(height: 30.h),
        MobileTechPostTitle(
          number: 7,
          ...
          onTap: () => context.push('/tech-blog/post/freezed'),
        ),
        SizedBox(height: 30.h),
        MobileTechPostTitle(
          number: 8,
          ...
          onTap: () => context.push('/tech-blog/post/json-serializable'),
        ),
        SizedBox(height: 30.h),
        MobileTechPostTitle(
          number: 9,
          ...
          onTap: () => context.push('/tech-blog/post/future-builder'),
        ),
        SizedBox(height: 30.h),
        MobileTechPostTitle(
          number: 10,
          ...
          onTap: () => context.push('/tech-blog/post/lifecycle'),
        ),
      ],
    );
  }
