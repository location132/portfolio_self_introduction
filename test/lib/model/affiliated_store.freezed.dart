...
mixin _$AffiliatedStoreModel {
  ...
  @JsonKey(ignore: true)
  $AffiliatedStoreModelCopyWith<AffiliatedStoreModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AffiliatedStoreModelCopyWith<$Res> {
  factory $AffiliatedStoreModelCopyWith(AffiliatedStoreModel value,
          $Res Function(AffiliatedStoreModel) then) =
      _$AffiliatedStoreModelCopyWithImpl<$Res, AffiliatedStoreModel>;
  @useResult
  $Res call(
      {int marketId,
      String mainCategory,
...
/// @nodoc
class _$AffiliatedStoreModelCopyWithImpl<$Res,
        $Val extends AffiliatedStoreModel>
    implements $AffiliatedStoreModelCopyWith<$Res> {
  _$AffiliatedStoreModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AffiliatedStoreModelImplCopyWith<$Res>
    implements $AffiliatedStoreModelCopyWith<$Res> {
  factory _$$AffiliatedStoreModelImplCopyWith(_$AffiliatedStoreModelImpl value,
          $Res Function(_$AffiliatedStoreModelImpl) then) =
      __$$AffiliatedStoreModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int marketId,
...
/// @nodoc
class __$$AffiliatedStoreModelImplCopyWithImpl<$Res>
    extends _$AffiliatedStoreModelCopyWithImpl<$Res, _$AffiliatedStoreModelImpl>
    implements _$$AffiliatedStoreModelImplCopyWith<$Res> {
  __$$AffiliatedStoreModelImplCopyWithImpl(_$AffiliatedStoreModelImpl _value,
      $Res Function(_$AffiliatedStoreModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AffiliatedStoreModelImpl(
      marketId: null == marketId
          ? _value.marketId
          : marketId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$AffiliatedStoreModelImpl implements _AffiliatedStoreModel {
  const _$AffiliatedStoreModelImpl(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AffiliatedStoreModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AffiliatedStoreModelImplCopyWith<_$AffiliatedStoreModelImpl>
      get copyWith =>
          __$$AffiliatedStoreModelImplCopyWithImpl<_$AffiliatedStoreModelImpl>(
              this, _$identity);
}

abstract class _AffiliatedStoreModel implements AffiliatedStoreModel {
  const factory _AffiliatedStoreModel(
      ...
      required final int maxDiscountRate}) = _$AffiliatedStoreModelImpl;
