...
class StoreBestReviewContentDetail extends StatefulWidget {
  final Map<String, dynamic> reviews;
  final int? index;
  const StoreBestReviewContentDetail(
      {super.key, required this.reviews, this.index});

  @override
  State<StoreBestReviewContentDetail> createState() =>
      _StoreBestReviewContentDetail();
}

class _StoreBestReviewContentDetail
    extends State<StoreBestReviewContentDetail> {
